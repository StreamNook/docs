---
title: UI Plugins and the api Object
description: The in-app ui runtime kind, the complete api surface, slots, bundling, and hybrid plugins.
---
...
<Info>
  New here? Start with [the quickstart](/docs/plugin-quickstart) and [the manifest reference](/docs/plugin-manifest). This page assumes you know the basics and focuses on the in-app runtime.
</Info>
...
<Note>
  See [the manifest reference](/docs/plugin-manifest) for the full schema of every field.
</Note>
...
<Tip>
  Need the host method and hook calls that hybrid plugins lean on? See [the host methods reference](/docs/api-host-methods) and [the hooks reference](/docs/api-hooks).
</Tip>
